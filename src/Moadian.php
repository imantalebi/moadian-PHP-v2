...
namespace Imantalebi\Moadian;

use DateTimeInterface;
use Imantalebi\Moadian\Exceptions\ErrorHandel;
use Imantalebi\Moadian\Services\JsonService;
...
class Moadian {
    ...
    public function __construct($clientId, $privateKeyBase64, $certificateBase64, $sandBox = false) {
...
//exit;
        ...
        throw new ErrorHandel('خطا در دریافت اطلاعات اولیه از سرور مودیان');
    }
